...
var panorama = new
PANOLENS.ImagePanorama('Pano1.jpg');
var panorama2 = new
PANOLENS.ImagePanorama('Pano2.jpg');
var panorama3 = new
PANOLENS.ImagePanorama('Pano3.jpg');
...
infospot.position.set(50, -1000, -4000);
...
infospot2.position.set(-1500, -800, -5000);
...
infospot3.position.set(1500, -900, -5000);
